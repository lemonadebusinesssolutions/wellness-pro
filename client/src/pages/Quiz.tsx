...
export default function Quiz() {
  ...
  const submitMutation = useMutation({
    mutationFn: async (data: SubmitQuizPayload) => {
      return await apiRequest<{ result: { id: number } }>("/api/submit-quiz", {
        method: "POST",
        body: data,
      })
    },
      ...
      <main className="flex-grow">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <div className="h-8 bg-gray-200 rounded animate-pulse w-1/3 mx-auto mb-2" />
            <div className="h-4 bg-gray-200 rounded animate-pulse w-2/3 mx-auto mb-6" />
            <div className="h-2 bg-gray-200 rounded animate-pulse w-full mb-8" />
